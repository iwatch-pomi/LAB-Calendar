  ...
  return (
    ...
    >
      ...
      <LegalSection heading="8. 保存期間">
        <p>
          取得した情報は、本サービスの提供に必要な期間、保存します。アカウントを
          削除した場合、そのアカウントに紐づく予定・実験・ToDo などのデータは
          あわせて削除されます。お問い合わせの内容は、対応の記録として一定期間
          保存することがあります。
        </p>
      </LegalSection>
      ...
      <LegalSection heading="9. 開示・訂正・削除の求め">
        <p>
          ご自身の個人情報の開示、訂正、利用停止、削除（アカウントの削除を含みます）を
          ご希望の場合は、末尾の連絡先までご連絡ください。ご本人であることを確認の
          うえ、法令に従い対応します。
        </p>
        <p className="text-gray-500 dark:text-gray-400">
          ※ 現在、画面上でアカウントを削除する機能はご用意していません。削除を
          ご希望の場合は、お手数ですがご連絡ください。
        </p>
      </LegalSection>
