...
/**
 * 共有・研究室のページ。タブで2つを切り替える。
 *
 * 共有タブ:
 * ・自分のカレンダーを誰に見せているか（作成・取り消し）
 * ・自分が見られる他人のカレンダー一覧
 * 研究室タブ: LabPanel（/lab と同じ中身）
 */
export function SharedManager({
  ...
  /**
   * タブの状態はURLに載せていない。/lab が単独のページとして残っているので、
   * 研究室を直接開きたいときはそちらを使えばよく、?tab= を足すと
   * useSearchParams の Suspense 境界だけが増える。
   */
    ...
    <ThemeRoot>
      <div className="min-h-screen bg-[#f6f8fa] dark:bg-gray-950">
        ...
        <main className="mx-auto max-w-3xl px-5 py-6">
          {/* 見出しはタブで入れ替えない。押すたびに変わると1つの画面に見えない */}
          <div className="mb-4">
            <h1 className="text-xl font-bold text-gray-800 dark:text-gray-100">共有・研究室</h1>
