      ...
      <div className="min-h-screen bg-[#f6f8fa] dark:bg-gray-950">
        <header className="border-b border-gray-200 bg-white dark:bg-gray-900 dark:border-gray-800">
          <div className="mx-auto flex max-w-3xl items-center justify-between gap-3 px-5 py-3">
            ...
            <Link
              href="/lab"
              className="flex items-center gap-1.5 rounded-lg border border-gray-200 px-3 py-1.5 text-sm font-medium text-gray-600 transition hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-gray-800 dark:border-gray-700"
            >
        ...
        <main className="mx-auto max-w-3xl px-5 py-6">
          <div className="mb-5">
            <h1 className="text-xl font-bold text-gray-800 dark:text-gray-100">カレンダーの共有</h1>
              ...
              <div className="space-y-1.5">
                {incoming.map((ownerId) => {
                  ...
                  return (
                    <div
                      key={ownerId}
                      className="flex items-center gap-2 rounded-xl border border-gray-200 bg-gray-50/60 p-2.5 dark:bg-gray-800/40 dark:border-gray-700"
                    >
                      <span
          ...
          <section className="mb-6 rounded-2xl border border-gray-200 bg-white p-4 dark:bg-gray-900 dark:border-gray-800">
            ...
            <form onSubmit={submit} className="space-y-3">
              <label className="block text-xs font-semibold text-gray-600 dark:text-gray-300">
                ...
                <input
                  ...
                  className="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 text-sm font-normal outline-none focus:border-brand-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100"
                />
              </label>
            ...
            {notice && (
              <p className="mt-3 rounded-lg bg-brand-50 px-3 py-2 text-xs text-brand-700 dark:bg-brand-900/20 dark:text-brand-300">
                {notice}
              </p>
            )}
            {justInvited && (
          ...
          {invitations.length > 0 && (
            <section className="mb-6 rounded-2xl border border-gray-200 bg-white p-4 dark:bg-gray-900 dark:border-gray-800">
              <div className="mb-1 flex items-center gap-1.5">
                <MailPlus className="h-4 w-4 text-gray-400 dark:text-gray-500" />
                <h2 className="text-sm font-semibold text-gray-700 dark:text-gray-200">招待中</h2>
          ...
          <section className="mb-6 rounded-2xl border border-gray-200 bg-white p-4 dark:bg-gray-900 dark:border-gray-800">
            <div className="mb-3 flex items-center gap-1.5">
              ...
              <h2 className="text-sm font-semibold text-gray-700 dark:text-gray-200">共有中</h2>
              <span className="text-xs text-gray-400 dark:text-gray-500">{myShares.length}</span>
            </div>
                ...
                {myShares.map((s) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="shrink-0 rounded-full bg-white px-2 py-0.5 text-[11px] text-gray-500 ring-1 ring-gray-200 dark:bg-gray-900 dark:text-gray-400">
                        {what}
                      </span>
                      <span className="shrink-0 rounded-full bg-white px-2 py-0.5 text-[11px] text-gray-500 ring-1 ring-gray-200 dark:bg-gray-900 dark:text-gray-400">
...
function InvitePrompt({
  ...
  return (
    <div className="mt-3 rounded-lg bg-brand-50 px-3 py-3 text-xs text-brand-800 dark:bg-brand-900/20 dark:text-brand-300">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button
          type="button"
          onClick={copy}
          className="flex items-center gap-1.5 rounded-lg border border-brand-300 bg-white px-3 py-1.5 text-xs font-medium text-brand-700 transition hover:bg-brand-100 dark:bg-gray-900 dark:text-brand-300 dark:border-brand-700"
        >
          {copied ? (
...
function InvitationRow({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 rounded-xl border border-gray-200 bg-gray-50/60 p-2.5 dark:bg-gray-800/40 dark:border-gray-700">
      <span className="min-w-0 flex-1 truncate text-sm font-medium text-gray-700 dark:text-gray-200">
        {invitation.email}
      </span>
      <span className="shrink-0 rounded-full bg-white px-2 py-0.5 text-[11px] text-gray-500 ring-1 ring-gray-200 dark:bg-gray-900 dark:text-gray-400">
