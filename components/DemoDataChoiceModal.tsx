...
export function DemoDataChoiceModal({
  ...
  return (
    <div className="fixed inset-0 z-[65] grid place-items-center overflow-y-auto bg-[#f6f8fa] p-4">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          <div className="mb-4 flex items-start gap-3">
            ...
            <h1 className="mt-1.5 text-lg font-bold leading-snug text-gray-800">
              サンプルの実験データを使いますか？
            </h1>
          </div>
          ...
          <div className="flex flex-col gap-2 sm:flex-row">
            ...
            <button
              onClick={onSkip}
              disabled={saving}
              className="flex-1 rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-600 transition hover:bg-gray-50 disabled:opacity-60"
            >
              空の状態で始める
            </button>
          </div>
